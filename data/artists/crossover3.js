// Batch 13 — Mainstage / techno-trance / Coldharbour tech-uplifting (added 2026-05-10)
// Adds KhoMha (CO Coldharbour tech-uplifting), i_o (US techno-trance,
// active 2017–2020 — neutral musical-legacy framing per project policy),
// and W&W (NL Mainstage Music duo). Schema mirrors crossover2.js.

export const crossover3 = [
  {
    slug: 'khomha',
    name: 'KhoMha',
    flag: '🇨🇴',
...
オペレーター・ノート：毎週ASOTおよび2018年Tomorrowland Arminメインステージに基盤を置くリスナーにとって、i_oはテクノ・トランス境界が2010年代末にリアルタイムでいかに再構築されつつあったかの作業上の実証である。「444」三部作のアシッド主導ピークタイム・アレンジメントはFSOE 138レジスターに十分近く、ArminはASOTでカタログをプレイした。Arminの「Mr. Navigator」のi_o公式リミックスはその対話の最もクリーンな単一作品として残る——オペレーターの7年間のASOT食事が、より硬いmau5trapレンズを通してレンダリングされた同じドロップ・ダイナミクスを認識する。`,
...

  {
    ...
    links: {
      beatport: 'https://www.beatport.com/search?q=W%26W',
      website: 'https://www.wandwmusic.com/about',
      wikipedia: 'https://en.wikipedia.org/wiki/W%26W',
    },
