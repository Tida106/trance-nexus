// Batch 8 — Progressive tier (added 2026-05)
//
// The progressive house / progressive trance lineage from Sasha & Digweed's
// Northern Exposure era through to the modern Anjunabeats melodic players.

export const progressive2 = [
  {
    slug: 'sasha',
    name: 'Sasha',
    flag: '🏴󠁧󠁢󠁷󠁬󠁳󠁿',
    ...
    tags: ['PROGRESSIVE HOUSE', 'LEGEND', 'WELSH'],
    realName: 'Alexander Paul Coe',
    origin: 'Bangor, Wales',
    born: '1969',
    activeFrom: '1989',
...
Sashaはグラミー賞にノミネートされた史上初のDJで、Twilo、Avalon、Hï Ibizaなど世界各地のクラブでレジデントを務めてきた。自身のLast Night On Earthレーベルは2014年から運営され、『Scene Delete』（2016）は新世代のメロディック・ハウス・プロデューサーに対する自身の有意性を再宣言した作品となった。`,
...

  {
    ...
    genre: 'PROGRESSIVE',
    banner: 'b-progressive',
    tags: ['PROGRESSIVE HOUSE', 'LEGEND', 'BRITISH'],
    realName: 'John Digweed',
    origin: 'Hastings, England',
    born: '1967',
    activeFrom: '1992',
    labels: ['Bedrock Records', 'Boxed', 'Global Underground'],
    topWorks: [
    ...
    short: {
      en: 'Long-time Sasha partner, founder of Bedrock Records, and host of the long-running Transitions radio show.',
      ja: 'Sashaとの長年のパートナー。Bedrock Recordsの創設者であり、長期放送中のラジオ「Transitions」のホスト。',
    },
    style: {
      en: 'Deep, hypnotic progressive house — relentless rhythmic drive, careful long-form arrangement, and a darker tech-leaning palette than Sasha\'s. His sets often run six hours or more.',
...
1999年設立のBedrock Recordsは、ディグウィードのプログレッシブ・ハウス系譜とテック寄りのスペクトラムを横断する数百のタイトルをリリース。2005年から週次で放送中の「Transitions」はダンス・ミュージックで最も尊敬されるミックス番組の一つで在り続けている。`,
...

  {
    ...
    genre: 'PROGRESSIVE',
    banner: 'b-progressive',
    tags: ['PROGRESSIVE HOUSE', 'ARGENTINIAN', 'LONG-FORM'],
    realName: 'Hernán Eduardo Cattáneo',
    origin: 'Buenos Aires, Argentina',
    born: '1965',
    activeFrom: '1990',
    labels: ['Sudbeat Music', 'Renaissance Records', 'Bedrock'],
    topWorks: [
    ...
    short: {
      en: 'Argentina\'s most internationally recognised DJ, founder of Sudbeat, and the leading figure in the South American progressive-house lineage.',
      ja: 'アルゼンチンを代表する国際的に最も認知されたDJ。Sudbeatの創設者であり、南米プログレッシブ・ハウス系譜の中心人物。',
    },
    style: {
      en: 'Lush, sun-drenched progressive house — the so-called "South American sound" of long melodic builds, warm chord pads, and emotional sundown peaks. His Buenos Aires Mandarine Park open-air sets are legendary for stretching past eight hours.',
      ja: '豊潤で陽光に満ちたプログレッシブ・ハウス——いわゆる「南米サウンド」——長いメロディック・ビルド、暖かなコード・パッド、情緒的なサンダウン・ピーク。ブエノスアイレスのMandarine Parkで行われる屋外セットは8時間以上に及ぶことで伝説化している。',
    },
    bio: {
      en: `Hernán Eduardo Cattáneo, born in Buenos Aires in 1965, started DJing in 1990 and is the most internationally recognised DJ to emerge from Argentina. His decade of building the Argentine progressive scene through the 1990s — initially around Buenos Aires venues and the Pacha Buenos Aires residency — was rewarded in 2001 when Paul Oakenfold invited him to play at his Cream resident night, the moment that broke Cattáneo onto the international stage and aligned him with the Renaissance / Bedrock progressive lineage.
...
ブエノスアイレスのMandarine Parkで開催される屋外パーティーは日没から翌朝まで続くのが定例で、世界中のプログレッシブ・ハウス・ファンにとっての年次巡礼地となっている。アルゼンチンのDJ Mag第1位を10年以上にわたり保持。`,
...

  {
    ...
    genre: 'PROGRESSIVE',
    banner: 'b-progressive',
    tags: ['MELODIC PROGRESSIVE', 'ANJUNABEATS', 'AMERICAN'],
    realName: 'Andrew Bayer',
    ...
    short: {
      en: 'Anjunabeats\' most musically ambitious producer — In My Last Life and It Happened One Night are widely cited as the genre\'s recent high-water marks.',
      ja: 'Anjunabeatsで最も音楽的に野心的なプロデューサー。『In My Last Life』と『It Happened One Night』はジャンル近年の最高到達点として広く挙げられる。',
    },
    style: {
      en: 'Composer-led melodic progressive — chord-rich harmonic writing, real instrumentation woven into electronic production, and song structures borrowed from indie and ambient. Bayer trained as a classical composer.',
      ja: '作曲家主導のメロディック・プログレッシブ——豊潤な和声、電子プロダクションに織り込まれた生楽器、インディ／アンビエントから借用された楽曲構成。Bayerはクラシック作曲家としての訓練を受けている。',
    },
    bio: {
      en: `Andrew Michael Bayer is an American DJ and Grammy-nominated producer born in 1986 in Washington, D.C. Piano-trained as a child, he graduated with a degree in music synthesis from the Berklee College of Music — a classical-composition background that distinguishes his catalogue from the rest of the modern progressive-trance roster. He started producing professionally at age 15 in 2001, and in 2003 founded the Signalrunners project with Scottish producer Alan Nimmo, releasing thirteen singles and EPs through 2008 including "Meet Me in Montauk", "Leaving London", "Aria Epica", and "These Shoulders" — landing on Anjunabeats by 2008.

His debut solo album It's Artificial was released on Anjunabeats on 25 July 2011, followed by If It Were You, We'd Never Leave (April 2013). The 2018 follow-up In My Last Life — five years in the making and released to critical acclaim — alongside It Happened One Night (2020) are widely cited as the most artistically complete albums in the modern Anjunabeats catalogue. Notable solo and collaborative singles include "Once Lydian", the three-track "Need Your Love / England / Detuned", "Follow the Light" (with Arty), and "Destiny" (with Ilan Bluestone).
...
アルバム『If It Were You, We\'d Never Leave』（2011）、『In My Last Life』（2018）、『It Happened One Night』（2020）は現代Anjunabeatsカタログで最も芸術的に完成度の高い作品として広く挙げられる。Above & Beyondの常連コラボレーターでもあり——特に「My Molecule」とアルバム『Common Ground』で——自身名義で映画や短編作品の音楽も手がけている。`,
...

  {
    ...
    genre: 'PROGRESSIVE',
    banner: 'b-progressive',
    tags: ['MELODIC PROGRESSIVE', 'ANJUNABEATS', 'BRITISH'],
    realName: 'Mike Daye',
    ...
    labels: ['Anjunabeats'],
    topWorks: [
      { title: 'Stadium Four', year: 2014, type: 'track' },
      { title: 'Above the Clouds', year: 2017, type: 'track' },
      { title: 'Where Did You Go (with Sunny Lax)', year: 2019, type: 'track' },
      { title: 'Genix - Live at Group Therapy', year: '2010s–', type: 'live mix' },
      { title: 'Wide Awake EP', year: 2021, type: 'EP' },
    ],
    ...
    short: {
      en: 'Long-time Anjunabeats producer best known for the festival-scale "Stadium Four" — a defining track of the modern Anjuna sound.',
      ja: 'フェス規模の「Stadium Four」で知られる長年のAnjunabeatsプロデューサー。現代Anjunaサウンドを定義するトラックの一つを生んだ。',
    },
    style: {
      en: 'Big-room melodic progressive with peak-time energy and emotional breakdowns — the Anjuna mainstage template that pairs well with Above & Beyond, ilan Bluestone, and Sunny Lax.',
      ja: 'ピークタイムのエネルギーと情緒的なブレイクダウンを併せ持つビッグルーム・メロディック・プログレッシブ——Above & Beyond、ilan Bluestone、Sunny Laxと相性の良いAnjunaメインステージのテンプレート。',
    },
    bio: {
      en: `Mike Daye, performing as Genix, is a Stoke-on-Trent producer who has been one of Anjunabeats' most reliable contributors since his 2010 label debut. He came up through the late-2000s UK trance scene with early releases on Adrian & Raz, AVA Recordings, and a series of independent imprints before signing to Anjunabeats — the move that placed him at the centre of the late-decade melodic-progressive lineage alongside Andrew Bayer, Ilan Bluestone, and Sunny Lax.
...
Beyond original releases, Genix is a regular at ABGT live events, Anjunadeep / Anjunabeats Open Air editions, and the broader Above & Beyond touring calendar. His remix work spans the full Anjuna roster, and his GenixMusic.com web presence and steady Anjunabeats single calendar position him as one of the label's most dependable workhorses — a producer whose name on a track is itself a quality signal for the modern Anjuna mainstage audience.`,
      ja: `Genix名義のマイク・デイは2010年以降Anjunabeatsで最も安定したプロデューサーの一人。2014年「Stadium Four」——舞い上がるシンセラインとフェス規模のドロップで構成された——は現代Anjunaサウンドを定義するトラックの一つとなり、Above & Beyondのラジオ「Group Therapy」の定番に。Sunny Lax、ilan Bluestoneとの共作を含めAnjunabeatsから安定的にリリースし、ABGTライブ・イベントの常連となっている。`,
    },
    mentionedIn: ['above-beyond-anjuna-empire'],
  },

  {
    ...
    bio: {
      en: `Ilan Bluestone is a London-based DJ-producer who has been one of the headline names on Above & Beyond's Anjunabeats label since 2012. He started releasing in 2008 with his debut single "Filthy Geezer" on L8-Night Records, but his Anjunabeats breakthrough came with the 2012 single "Capetown" — the record that pushed him from local-circuit producer into international rotation across Above & Beyond's Group Therapy radio show.
...
Bluestone runs his own Anjunabeats sub-label Stoneblue Records, has performed at Tomorrowland, Ultra Europe, EDC Las Vegas, and the full ABGT live calendar, and remains one of the most consistently booked names in modern melodic-progressive trance. The combination of cinematic chord work, anthemic lead writing, and long-form emotional breakdowns has made him a reference point for the Anjunabeats mainstage aesthetic alongside Andrew Bayer and Genix.`,
...

  {
    ...
    bio: {
      en: `Otto Yliperttula, performing as Yotto, is a Finnish DJ and producer born in Helsinki on 8 October 1986. He started his musical career as a member of the Helsinki-based melodic-house duo Something Good before going solo, and his run of remixes and originals caught the ear of Anjunadeep label boss James Grant, who signed him to the label in 2015 — before his 30th birthday.

Yotto's first original Anjunadeep productions arrived in April 2016: a two-track EP pairing "Aviate" and "Crosswalk", with "Aviate" earning an Essential New Tune selection on Pete Tong's BBC Radio 1 show. The June 2016 follow-up "The Owls" picked up his fourth Essential New Tune and was named "Hottest Record in the World" by Annie Mac. His debut album Hyperfall was released through Anjunadeep on 7 September 2018 and has since accumulated more than 20 million Spotify streams — widely regarded as one of the defining records of the late-2010s melodic-house wave alongside Lane 8, Tinlicker, and Ben Böhmer.

In 2019 Yotto launched his own label Odd One Out with the single "Shifter", giving himself an outlet for more experimental work while continuing to release on Anjunadeep through 2021. His remix catalogue extends well beyond the Anjuna ecosystem to include reworks for Gorillaz, Rufus Du Sol, and Coldplay. Yotto performs at the full Anjunadeep Open Air calendar (Prague, London, ABGT editions) and is one of the most internationally booked Finnish electronic-music exports of the 2020s.`,
