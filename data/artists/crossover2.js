// Batch 11 — Modern crossover tier (added 2026-05-09)
// Continues the genre-mixed crossover bucket started in crossover.js.
// Same schema and rendering parity as the established uplifting/vocal/
// psy files. No-fabrication discipline applied throughout — verifiable
// career facts only, bios shorten where the public record is thin.

export const crossover2 = [
  {
    slug: 'hi-lo',
    name: 'HI-LO',
    flag: '🇳🇱',
    ...
    genre: 'TECH',
    banner: 'b-tech',
    tags: ['DARK PROGRESSIVE', 'TECHNO', 'DUTCH', 'OLIVER HELDENS'],
    ...
    sub: { en: 'Dark Progressive / Techno', ja: 'ダーク・プログレッシブ / テクノ' },
    short: {
      en: 'Dark techno alias of Dutch DJ/producer Oliver Heldens, releasing through his own Heldeep Records and Lyase imprints since 2016.',
      ja: 'オランダのDJ／プロデューサーOliver Heldensによるダーク・テクノ名義。2016年以降、自身のHeldeep RecordsおよびLyaseインプリントからリリースを行う。',
    },
    style: {
      en: 'Dark, percussive techno with progressive-trance breakdown DNA — drops engineered for festival mainstage scale, harmonic content sparser than melodic-trance, rhythmic content denser than peak-time uplifting.',
