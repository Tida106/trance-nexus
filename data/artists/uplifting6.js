// Batch 9 — Uplifting / Pure Trance / Armada modern tier (added 2026-05-09)
// Schema mirrors uplifting2.js. Final batch in the 70 → 85 expansion.
// Same caveats as uplifting4.js / uplifting5.js — verifiable career
// facts only, bios shorten when the public record is thin.

export const uplifting6 = [
  {
    slug: 'paul-webster',
    name: 'Paul Webster',
    flag: '🇮🇪',
    ...
    genre: 'UPLIFTING',
    banner: 'b-uplifting',
    tags: ['UPLIFTING', 'TECH UPLIFTING', 'IRISH'],
...
トランス・エコシステム内において、XiJaro & PitchはFSOE／138側面に位置する——Aly & Filaの編集方針、Who's Afraid Of 138?!サブレーベル、より広いSubculture／Pure Trance／Grotesqueサーキットが定義するレーン。2010年代後半のピーク期と現在の復活期の両方を通じてそのレーンに留まり続けてきた、より一貫した名前の一つである。`,
...

  {
    ...
    genre: 'UPLIFTING',
    banner: 'b-uplifting',
    tags: ['UPLIFTING', 'ORCHESTRAL', 'FINNISH-SLOVAKIAN'],
