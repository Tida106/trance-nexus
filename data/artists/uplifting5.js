// Batch 8 — Uplifting / Tech-uplifting / Veterans tier (added 2026-05-09)
// Schema mirrors uplifting2.js — same caveats as uplifting4.js: where
// the public record (Wikipedia, Discogs, label release pages, Beatport
// charts, ASOT programming notes) thins out, the bio shortens
// accordingly and unverified specifics are simply omitted.

export const uplifting5 = [
  {
    slug: 'factor-b',
    name: 'Factor B',
    flag: '🇦🇺',
