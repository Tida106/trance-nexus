...
This is the corner of the trance family I came to later. The 2018 Tomorrowland moment that pulled me in was Armin van Buuren on mainstage and Sun & Moon was the song that hit; seven years of weekly A State of Trance listening since has been mostly uplifting. Reading back into Goa was a separate, slower process — going from the European stadium sound to its psychedelic ancestor felt like meeting the great-grandparent of the music I loved, and made me hear the genealogy differently every time.`,
...
これは私がトランスファミリーで後から出会ったコーナーだ。私を引き込んだ2018年のTomorrowlandの瞬間はメインステージのArmin van BuurenでSun & Moonがヒットした曲だった。それから7年間の毎週のA State of Trance聴取はほとんどアップリフティングだった。ゴアへ遡って読み直すことは別個の、よりゆっくりとしたプロセスだった——ヨーロッパのスタジアム・サウンドからそのサイケデリックな祖先へ向かうのは、自分が愛した音楽の曽祖父母に会うような感覚で、聴くたびに系譜の聞こえ方を変えるものだった。`,
    },
